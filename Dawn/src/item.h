...
namespace ArmorType
{
  ...
  inline ArmorType getHighestArmorTypeByClass( CharacterClass::CharacterClass characterClass )
  {
  ...
  inline std::string getArmorTypeText(ArmorType armorType )
  {
    switch( armorType )
    {
...
namespace WeaponType
{
  ...
  inline std::string getWeaponTypeText (WeaponType weaponType )
  {
    switch( weaponType )
    {
